                ...
                <div class="col-sm-4 ">
                    ...
                    <div class="col-md-4 comp-grid">
                        <form method="get" action="<?php print_link($current_page) ?>" class="form filter-form">
                            <div class="card mb-3">
                                <div class="card-header h4 h4">Filter by Kegiatan Tanggal Kegiatan</div>
                                <div class="p-2">
                                    <input class="form-control datepicker"  value="<?php echo $this->set_field_value('kegiatan_tanggal_kegiatan') ?>" type="datetime"  name="kegiatan_tanggal_kegiatan" placeholder="" data-enable-time="" data-date-format="Y-m-d H:i:S" data-alt-format="M j, Y - H:i" data-inline="false" data-no-calendar="false" data-mode="single" />
                                    </div>
                                </div>
                                <hr />
                    ...
                    <div class="row ">
                        <div class="col-md-12 comp-grid">
                            ...
                            <div class="filter-tags mb-2">
                                <?php
                                if(!empty($_GET['kegiatan_tanggal_kegiatan'])){
                                ?>
                                <div class="filter-chip card bg-light">
                                    <b>Kegiatan Tanggal Kegiatan :</b> 
                                    <?php
                                    $date_val = get_value('kegiatan_tanggal_kegiatan');
                                    $formated_date = "";
                                    ...
                                    echo  $formated_date;
                                    $remove_link = unset_get_value('kegiatan_tanggal_kegiatan', $this->route->page_url);
                                    ?>
                                        ...
                                        <table class="table  table-striped table-sm text-left">
                                            <thead class="table-header bg-light">
                                                <tr>
                                                    ...
                                                    <th  class="td-lokasi_kegiatan"> Lokasi Kegiatan</th>
                                                    <th  class="td-deskripsi_kegiatan"> Deskripsi Kegiatan</th>
                                                    <th  class="td-kategori_kegiatan"> Kategori Kegiatan</th>
