...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Tambah Kegiatan</h4>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-nama_kegiatan"  value="<?php  echo $this->set_field_value('nama_kegiatan',""); ?>" type="text" placeholder="Masukan Nama Kegiatan"  required="" name="nama_kegiatan"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
