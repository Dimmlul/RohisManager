                ...
                <div class="col-sm-4 ">
                    ...
                    <div class="col-md-4 comp-grid">
                        <form method="get" action="<?php print_link($current_page) ?>" class="form filter-form">
                            <div class="card mb-3">
                                <div class="card-header h4 h4">Filter by Tanggal Pengumuman</div>
                                <div class="p-2">
                                    <input class="form-control datepicker"  value="<?php echo $this->set_field_value('pengumuman_tanggal_pengumuman') ?>" type="datetime"  name="pengumuman_tanggal_pengumuman" placeholder="" data-enable-time="" data-date-format="Y-m-d H:i:S" data-alt-format="M j, Y - H:i" data-inline="false" data-no-calendar="false" data-mode="single" />
                                    </div>
                                </div>
                                <hr />
                    ...
                    <div class="row ">
                        <div class="col-md-12 comp-grid">
                            ...
                            <div class="filter-tags mb-2">
                                <?php
                                if(!empty($_GET['pengumuman_tanggal_pengumuman'])){
                                ?>
                                <div class="filter-chip card bg-light">
                                    <b>Pengumuman Tanggal Pengumuman :</b> 
                                    <?php
                                    $date_val = get_value('pengumuman_tanggal_pengumuman');
                                    $formated_date = "";
                                    ...
                                    echo  $formated_date;
                                    $remove_link = unset_get_value('pengumuman_tanggal_pengumuman', $this->route->page_url);
                                    ?>
                                        ...
                                        <table class="table  table-striped table-sm text-left">
                                            <thead class="table-header bg-light">
                                                <tr>
                                                    ...
                                                    <?php } ?>
                                                    <th class="td-sno">#</th>
                                                    <th  class="td-judul_pengumuman"> Judul Pengumuman</th>
                                                    <th  class="td-isi_pengumuman"> Isi Pengumuman</th>
                                                    <th  class="td-nama_kegiatan"> Nama Kegiatan</th>
                                                    <th  class="td-tanggal_pengumuman"> Tanggal Pengumuman</th>
                                                    <th  class="td-tanggal_kegiatan"> Tanggal Kegiatan</th>
                                                    <th class="td-btn"></th>
                                                </tr>
                                            </thead>
                                            <?php
                                                ...
                                                <tr>
                                                    ...
                                                    <th class=" td-checkbox">
                                                        ...
                                                        <td class="td-tanggal_kegiatan">
                                                            <span <?php if($can_edit){ ?> data-source='<?php print_link('api/json/pengumuman_tanggal_kegiatan_option_list'); ?>' 
