                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <textarea placeholder="Enter Deskripsi Dokumen" id="ctrl-deskripsi_dokumen"  rows="5" name="deskripsi_dokumen" class=" form-control"><?php  echo $this->set_field_value('deskripsi_dokumen',""); ?></textarea>
